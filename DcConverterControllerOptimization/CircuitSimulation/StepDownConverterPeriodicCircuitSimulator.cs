...
{
    public class StepDownConverterPeriodicCircuitSimulator : ICircuitSimulator
    {
        ...
        public StepDownConverterPeriodicCircuitSimulator(double outputVoltageInitial, double outputVoltageGradientInitial, double inputVoltage, double alpha, double beta, double gamma, double radicand) {
